...
namespace LXP.Data.Repository
{
    public class MaterialRepository : IMaterialRepository
    {
        ...
        {
            return await _lXPDbContext.Materials.AnyAsync(material =>
        ...
        {
            return await _lXPDbContext.Materials.FirstOrDefaultAsync(material =>
                material.Name == materialName && material.Topic == topic
            );
        }
        ...
        )
        {
            return _lXPDbContext
                .Materials.Include(material => material.MaterialType)
        ...
        public async Task<List<Material>> GetMaterialsByTopic(Guid topic)
        {
            return await _lXPDbContext
                .Materials.Where(material => material.TopicId == topic)
                .ToListAsync();
        }
