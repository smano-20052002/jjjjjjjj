...
namespace LXP.Data.IRepository
{
    public interface IQuizEngineRepository
    {
        ...
        Task<LearnerAttemptViewModel> CreateLearnerAttemptAsync(
            Guid learnerId,
            Guid quizId,
            DateTime startTime
        );
        ...
        Task<IEnumerable<LearnerAttemptViewModel>> GetLearnerAttemptsForQuizAsync(
            Guid learnerId,
            Guid quizId
        );
        ...
        Task<IEnumerable<LearnerAnswerViewModel>> GetLearnerAnswersByAttemptAndQuestionAsync(
            Guid attemptId,
            Guid quizQuestionId
        ); //newly added
        Task CreateLearnerAnswerAsync(
